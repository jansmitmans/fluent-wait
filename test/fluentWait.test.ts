...
describe('fluentWait function', () => {
    ...
    it('should throw an error if the condition is not satisfied within the timeout period', async () => {
        ...
        await expect(fluentWait(functionToExecute, condition, pollingConfiguration)).rejects.toThrow(
            'The condition was not satisfied within the timeout period.'
        );
    });
...
describe('FluentWait class', () => {
    ...
    it('should throw an error if the function to execute is not provided', async () => {
        ...
        await expect(new FluentWait().toBeFulfilledCondition(condition).execute()).rejects.toThrow(
            'You must provide a function to execute.'
        );
    });
    ...
    it('should throw an error if the condition is not provided', async () => {
        ...
        await expect(new FluentWait().withFunctionToExecute(functionToExecute).execute()).rejects.toThrow(
            'You must provide a condition.'
        );
    });
    ...
    it('should throw an error if the condition is not satisfied within the timeout period', async () => {
        ...
        await expect(
            new FluentWait()
                ...
                .execute()
        ).rejects.toThrow('The condition was not satisfied within the timeout period.');
    });
